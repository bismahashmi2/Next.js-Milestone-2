...
const Contact = () => {
  return (
    <div className="w-full min-h-screen py-40 px-4 leading-relaxed bg-gradient-to-b from-[#fef9c3] via-[#b2d8d8] to-[#fef9c3]">
      <div className="w-full bg-white max-w-xlg mx-auto rounded-lg shadow-md p-10">
        ...
        <form className="bg-peach rounded-lg shadow-lg p-8 sm:p-6 mt-6">
         ...
         <div className="mb-4">
            ...
            <input type="text" className="p-2" placeholder="Enter your name" required />
            </div> 
